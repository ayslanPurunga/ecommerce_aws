...
export class AuthInfoService {
    private cognitoIdentifyServiceProvider: CognitoIdentityServiceProvider

    constructor(cognitoIdentifyServiceProvider: CognitoIdentityServiceProvider) {
        this.cognitoIdentifyServiceProvider = cognitoIdentifyServiceProvider
    }
